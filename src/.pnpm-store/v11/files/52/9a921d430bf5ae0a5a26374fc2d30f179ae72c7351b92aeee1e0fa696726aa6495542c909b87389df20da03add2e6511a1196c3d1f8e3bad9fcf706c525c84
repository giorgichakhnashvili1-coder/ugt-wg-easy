...
import { HtmlAttributes, PropertyMeta, AlternateLanguageLink, CanonicalLink } from 'unhead/types';
 ...
 */
type NormalizedLocaleObject<T = Locale> = LocaleObject<T> & {
    domains: string[];
    defaultForDomains: string[];
    domainDefault?: never;
};
