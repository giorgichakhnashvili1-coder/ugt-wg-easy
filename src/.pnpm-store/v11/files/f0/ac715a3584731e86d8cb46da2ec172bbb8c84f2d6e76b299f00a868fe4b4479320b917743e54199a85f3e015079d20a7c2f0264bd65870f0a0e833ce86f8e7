 ...
 * loader in-process.
 */
export declare function createPrerenderablePredicate(config: Pick<DeliveryConfig, 'dynamic' | 'undeliverable'>): (locale: Locale) => boolean;
/**
 ...
 * was never rendered.
 */
export declare function createRuntimeLoaderPredicate(config: DeliveryConfig): (locale: Locale) => boolean;
